...
INSERT INTO person (id, first_name, last_name, email, dob, created_at, updated_at) SELECT id, first_name, last_name, email, dob, created_at, updated_at FROM person_temp;
